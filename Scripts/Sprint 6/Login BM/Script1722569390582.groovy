...
String password = GlobalVariable.pwBM
...
WebUI.takeScreenshot((((baseDir + GlobalVariable.screenshotPathAplBaru)) + '/' + konsumen  + '/' + 'Dashboard BM') + '.png', FailureHandling.STOP_ON_FAILURE)

WebUI.delay(5)
WebUI.click(findTestObject('Object Repository/xpath', ['xpath' : "(//img)[6]"]))
WebUI.delay(5)
WebUI.takeScreenshot((((baseDir + GlobalVariable.screenshotPathAplBaru)) + '/' + konsumen  + '/' + 'Halaman Approval') + '.png', FailureHandling.STOP_ON_FAILURE)