...
WebUI.click(findTestObject('Object Repository/xpath', ['xpath' : "(//app-form-data-konsumen//img[@class='img-placeholder'])[1]"]));
WebUI.uploadFile(findTestObject('Object Repository/xpath', ['xpath' : "//span[text()='Upload File']/preceding-sibling::input"]), selfiePath);

WebUI.delay(1);
WebUI.click(findTestObject('Object Repository/xpath', ['xpath' : "//div[@role='button']/img"]));
WebUI.click(findTestObject('Object Repository/xpath', ['xpath' : "//strong[text()='Hapus Foto']"]));

WebUI.delay(1);
WebUI.click(findTestObject('Object Repository/xpath', ['xpath' : "(//app-form-data-konsumen//img[@class='img-placeholder'])[1]"]));
WebUI.uploadFile(findTestObject('Object Repository/xpath', ['xpath' : "//span[text()='Upload File']/preceding-sibling::input"]), selfiePath);
WebUI.click(findTestObject('Object Repository/xpath', ['xpath' : "(//button[text()='Verifikasi'])[1]"]));
...
WebUI.uploadFile(findTestObject('Object Repository/xpath', ['xpath' : "//span[text()='Upload File']/preceding-sibling::input"]), ktpPath);
WebUI.click(findTestObject('Object Repository/xpath', ['xpath' : "//app-form-data-kepemilikan//div-select"]));
WebUI.click(findTestObject('Object Repository/xpath', ['xpath' : "(//*[@class='slide-up show']//strong[text()='$status_rumah'])[1]"]));
WebUI.click(findTestObject('Object Repository/xpath', ['xpath' : "//button[text()='Simpan']"]));
WebUI.click(findTestObject('Object Repository/xpath', ['xpath' : "//button[text()=' Selanjutnya ']"]));

WebUI.takeFullPageScreenshot((((baseDir + GlobalVariable.screenshotSimulasi)) + '/' + konsumen  + '/' + 'Simulasi Tab Konsumen') + '.png', FailureHandling.STOP_ON_FAILURE)
