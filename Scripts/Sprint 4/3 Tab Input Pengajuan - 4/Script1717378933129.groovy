...
WebUI.delay(1)
WebUI.click(findTestObject('Object Repository/xpath', ['xpath' : "(//app-form-matching-konsumen//fa-icon)[1]"]))
WebUI.click(findTestObject('Object Repository/xpath', ['xpath' : "(//app-form-matching-konsumen//fa-icon)[2]"]))
...
switch(konsumen) {
	...
	case 'D':
		WebUI.check(findTestObject('Object Repository/xpath', ['xpath' : "(//app-form-matching-penjamin//input)[1]"]))
		WebUI.check(findTestObject('Object Repository/xpath', ['xpath' : "(//app-form-matching-penjamin//input[@name='matchingPasanganPenjamin' and @value='none'])"]))
		break;
}
WebUI.delay(1)
