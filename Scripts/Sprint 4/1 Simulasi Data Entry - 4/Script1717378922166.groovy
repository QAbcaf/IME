...
switch (MatchingRO) {
        case 'Pengajuan':
        	...
        	WebUI.click(findTestObject('Object Repository/xpath', ['xpath' : "(//app-matching-ro//*[@class='match-detail-btn'])[1]"]))
        	WebUI.check(findTestObject('Object Repository/xpath', ['xpath' : "(//app-matching-ro//input[@name='matching'])[1]/following-sibling::span"]))
		...
		case 'Existing':
			...
			WebUI.click(findTestObject('Object Repository/xpath', ['xpath' : "(//app-matching-ro//*[@class='match-detail-btn'])[1]"]))
			WebUI.click(findTestObject('Object Repository/xpath', ['xpath' : "(//app-matching-ro//input[@name='matching'])[1]/following-sibling::span"]))
...
switch(SimulasiTLKonsumen) {
	case 'Dalam Negeri':
		...
		WebUI.check(findTestObject('Object Repository/xpath', ['xpath' : "(//input[@formcontrolname='tempatLahirLuarNegeri'])[1]/following-sibling::span"]))
		break;
	case 'Luar Negeri':
		WebUI.check(findTestObject('Object Repository/xpath', ['xpath' : "(//input[@formcontrolname='tempatLahirLuarNegeri'])[2]/following-sibling::span"]))
...
WebUI.delay(1)
WebUI.click(findTestObject('Object Repository/xpath', ['xpath' : "//input[@value='konsumen']/following-sibling::span"]));
