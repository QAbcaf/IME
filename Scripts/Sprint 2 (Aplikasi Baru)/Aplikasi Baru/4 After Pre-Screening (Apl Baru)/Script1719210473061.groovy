...
WebUI.takeFullPageScreenshot((((baseDir + GlobalVariable.screenshotPathAplBaru)) + '/' + konsumen  + '/' + 'Hasil Pre Screening') + '.png', FailureHandling.STOP_ON_FAILURE)
...
WebUI.delay(1)
WebUI.click(findTestObject('Object Repository/xpath', ['xpath' : "(//input[@name='matching-watchlist-konsumen'])[1]/following-sibling::span"]));
WebUI.delay(1)
WebUI.takeFullPageScreenshot((((baseDir + GlobalVariable.screenshotPathAplBaru)) + '/' + konsumen  + '/' + 'Choose Data Konsumen') + '.png', FailureHandling.STOP_ON_FAILURE)

WebUI.scrollToElement(findTestObject('Object Repository/xpath', ['xpath' : "(//input[@name='matching-watchlist-pasangan'])[1]"]), 0);
WebUI.check(findTestObject('Object Repository/xpath', ['xpath' : "(//input[@name='matching-watchlist-pasangan'])[1]/following-sibling::span"]));
WebUI.takeFullPageScreenshot((((baseDir + GlobalVariable.screenshotPathAplBaru)) + '/' + konsumen  + '/' + 'Choose Data Pasangan') + '.png', FailureHandling.STOP_ON_FAILURE)
WebUI.delay(1)
WebUI.click(findTestObject('Object Repository/xpath', ['xpath' : "//app-prescreening-modal-detail//button[text()='Simpan']"]));
WebUI.delay(1)

WebUI.takeFullPageScreenshot((((baseDir + GlobalVariable.screenshotPathAplBaru)) + '/' + konsumen  + '/' + 'Sudah Memilih Watchlist') + '.png', FailureHandling.STOP_ON_FAILURE)
