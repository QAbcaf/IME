...
String login_role = GlobalVariable.loginRoleChecker
...
WebUI.takeScreenshot((((baseDir + GlobalVariable.screenshotPathAplBaru)) + '/' + konsumen  + '/' + 'Dashboard Checker') + '.png', FailureHandling.STOP_ON_FAILURE)