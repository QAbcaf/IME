...
WebUI.click(findTestObject('Object Repository/xpath', ['xpath' : "//button[text()=' Pre-Screen ']"]))
...
switch(isNamaSelainKonsumen) {
	...
	case 'y':
		...
		WebUI.setText(findTestObject('Object Repository/xpath', ['xpath' : "//input[@id='hubunganDenganDebitur' and @_ngcontent-ng-c3845014188='']"]), Cl_HubDebitur)
...
WebUI.click(findTestObject('Object Repository/xpath', ['xpath' : "//button[text()=' Selanjutnya ' and @_ngcontent-ng-c3845014188='']"]))